...
async def async_setup_entry(hass: HomeAssistant, config_entry: ConfigEntry, async_add_entities):
    ...
    for unit in units:
        ...
        _LOGGER.debug("Adding CasambiLightEntity...")
        casambi_light = CasambiLightEntity(unit, casambi_controller.controller, hass, coordinator)

        lights.append(casambi_light)
